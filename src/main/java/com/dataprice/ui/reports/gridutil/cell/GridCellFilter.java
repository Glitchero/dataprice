...
import com.dataprice.ui.reports.Position;
import com.dataprice.ui.reports.gridutil.cell.filter.*;
...
public class GridCellFilter<T> implements Serializable {
    ...
    /**
     * assign a <b>IndicatorFilter</b> to grid for given columnId
     *
     * @param columnId id of property
     * @return CellFilterComponent that contains ComboBox
     */
    public CellFilterComponent<ComboBox> setIndicatorFilter(String columnId) {
        CellFilterComponent<ComboBox> filter = new CellFilterComponent<ComboBox>() {
            ...
            public void triggerUpdate() {
                if (comboBox.getValue() != null) {
                    replaceFilter(new IndicatorFilter(comboBox.getValue().toString()), columnId);
                } else {
                    removeFilter(columnId);
                }
            }
            ...
            public ComboBox layoutComponent() {
              ...
              //  comboBox.setItems("Soy más barato","Tengo mismo precio","Soy más caro");
                comboBox.setItems(position.getPositionsList());
    ...
    /**
     * assign a <b>SimpleLabelFilter</b> to grid for given columnId<br>
     *
     * @param columnId        id of property
     ...
     */
    public CellFilterComponent<TextField> setLabelFilter(String columnId, boolean ignoreCase, boolean onlyMatchPrefix) {
        return setLabelFilter(columnId, ignoreCase, onlyMatchPrefix, null);
    }
     ...
     * @return CellFilterComponent that contains TextField
     */
    public CellFilterComponent<TextField> setLabelFilter(String columnId, boolean ignoreCase, boolean onlyMatchPrefix, String inputPrompt) {
        CellFilterComponent<TextField> filter = new CellFilterComponent<TextField>() {
            ...
            public void triggerUpdate() {
                if (currentValue == null || currentValue.isEmpty()) {
                    ...
                    replaceFilter(new SimpleLabelFilter(currentValue, ignoreCase, onlyMatchPrefix), columnId);
                }
            }
     ...
     * @return CellFilterComponent that contains TextField
     */
    public CellFilterComponent<TextField> setLinkFilter(String columnId, boolean ignoreCase, boolean onlyMatchPrefix) {
        return setLinkFilter(columnId, ignoreCase, onlyMatchPrefix, null);
    }
     ...
     * @return CellFilterComponent that contains TextField
     */
    public CellFilterComponent<TextField> setLinkFilter(String columnId, boolean ignoreCase, boolean onlyMatchPrefix, String inputPrompt) {
        CellFilterComponent<TextField> filter = new CellFilterComponent<TextField>() {
            ...
            public void triggerUpdate() {
                if (currentValue == null || currentValue.isEmpty()) {
                    ...
                    replaceFilter(new SimpleLinkFilter(currentValue, ignoreCase, onlyMatchPrefix), columnId);
                }
            }
