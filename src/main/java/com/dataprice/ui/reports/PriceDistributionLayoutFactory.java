		...
		public Component init() {
			 BarChartConfig config = new BarChartConfig();
		        config.data()
		            ...
		            .addDataset(new BarDataset().label("I'm cheaper").backgroundColor(DemoUtils.RGB_GREEN))
		            .addDataset(new BarDataset().label("Same prices").backgroundColor(DemoUtils.RGB_BLUE))
		            .addDataset(new BarDataset().label("I'm more expensive").backgroundColor(DemoUtils.RGB_RED))
		            .and()
		        .options()
		            .responsive(true)
		            .title()
		                .display(true)
		                .text("Price distribution" + " (" + competitorsUsedWithTotal.size() +" competitors)")
		                .and()
		            .tooltips()
