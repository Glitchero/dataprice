...
public interface ProductRepository extends JpaRepository<Product,String>{
	...
	*/
	...
	@Query("select p from Product p where p.seller=:sellerName and DATE(p.updateDay) >= :lastDate ")
	List<Product> getProductsForFeedNoMatches(@Param("sellerName") String sellerName, @Param("lastDate") Date lastDate);
